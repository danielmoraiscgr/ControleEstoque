...
namespace ControleEstoque.Web.Models
{
    ...
    {       
        ...
        [Required(ErrorMessage = "Preencha o nome.")] // Campo Obrigatorio     
        public string Nome { get; set; }


        [Required(ErrorMessage = "Preencha a sigla.")] // Campo Obrigatorio     
        ...
        public static List<UnidadeMedidaModel> RecuperarLista(int pagina, int tamPagina)
        {
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                using (var comando = new SqlCommand())
                {
                    ...
                    comando.CommandText = string.Format("Select * from unidade_medida order by nome offset {0} rows fetch next {1} rows only",
